        ...
        <a-layout style="min-height: 100vh">
            <a-layout-sider v-model:collapsed="collapsed" collapsible width="250px">
                ...
                <a-menu v-model:selectedKeys="selectedKeys" theme="dark" mode="inline">
                     ...
                     border-left: none;
                      ...
                      border-top: none; border-radius: 0 0 0 0px;">
                        <div class="flex justify-center">
                            ...
                            <div v-else>
                                <img style="height: 100px; width: 100px; border-radius: 50%; object-fit: cover; object-position: center;"
                    ...
                    <FinanceSideBar v-if="(userType('3') || userType('1')) && !userRole(3)" />
                    <CustodianSideBar v-if="(userType('4') || userType('1')) && !userRole(4)" />
                    <MarketingSideBar v-if="(userType('6') || userType('1')) && !userRole(6)" />
                    <IadSideBar v-if="(userType('10') || userType('1')) && !userRole(10)" />
            ...
            <ant-float v-if="(userType('2') || userType('1')  && !userRole(2)) && (page.pendingPrRequest.length) "/>
        </a-layout>
    </div>
</template>
