<template>
    ...
    <a-modal v-model:open="addStore" @ok="handleOk">
        ...
        <a-form-item for="store_name" :validate-status="form.errors.store_name ? 'error' : ''"
            :help="form.errors.store_name" style="margin-top: 10px;">Store
            Name:
...
import { FormOutlined, DeleteOutlined, PlusSquareOutlined, UserOutlined, UnlockTwoTone, CloseCircleTwoTone, AppstoreTwoTone, UndoOutlined, CloseSquareFilled } from '@ant-design/icons-vue';
            ...
            columns: [
                {
                    ...
                    sorter: (a, b) => {
                        return a.store_name.charAt(0).toUpperCase().localeCompare(b.store_name.charAt(0).toUpperCase());
                    }
                },
                {
                    title: 'Store Code',
