...
export default {
            ...
            columns: [
                {
                    ...
                    sorter: (a, b) =>
                        (a.insp_paymentnum || "").localeCompare(
                            b.insp_paymentnum || "",
                            undefined,
                            { sensitivity: "base" },
                        ),
                },
                {
                    ...
                    onFilter: (value, record) =>
                        record.insp_paymentcustomer === value,
                },
                {
                    title: "Customer",
                    dataIndex: "customer",
    ...
    methods: {
        ...
        viewSales(rec) {
            ...
            this.$inertia.get(
                route("storeaccounting.storeAccountingViewSales", rec.insp_id),
                {
