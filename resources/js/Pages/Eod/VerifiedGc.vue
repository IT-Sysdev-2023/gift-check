    ...
    <AuthenticatedLayout>
        <a-card>
            <div v-if="response.length" class="mb-4">
                <div>
                    <InfoCircleOutlined style="color: red;" /> <span style="color: red;"> Oppss barcode not found
                    </span>
                </div>
                <a-collapse v-model:activeKey="activeKey" ghost>
                    <a-collapse-panel key="1"
                        :header="activeKey == '0' ? 'Expand this to see the not found barcodes' : 'Click here to hide the barcodes'"
                        style="color: white;">
                        <a-card>
                            <a-divider style="font-size: 14px; color: red;">not found barcodes</a-divider>
            ...
            <a-table size="small" :pagination="false" :data-source="record.data" :columns="columns" bordered></a-table>
