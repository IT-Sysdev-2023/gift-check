        ...
        <a-layout style="min-height: 100vh">
            <a-layout-sider v-model:collapsed="collapsed" collapsible width="250px">
                ...
                <a-menu v-model:selectedKeys="selectedKeys" theme="dark" mode="inline">
                    ...
                    <a-sub-menu key="menu-sub-transactions" v-if="userType('2') && !userRole(2)">
                        <template #title>
                            <span>
                                <DollarOutlined />
                    ...
                    <a-sub-menu key="menu-sub-adjustments" v-if="userType('2') && !userRole(2)">
                        <template #title>
                            <span>
                                <SwapOutlined />
                    ...
                    <a-menu-item key="menu-item-budget-ledger" v-if="userType('2') && !userRole(2)">
                        <file-outlined />
                        <span>Budget Ledger</span>
                    </a-menu-item>
                    <a-menu-item key="menu-item-gc-ledger" v-if="userType('2') && !userRole(2)">
                        <file-outlined />
                        <span>GC Ledger</span>
                    </a-menu-item>

                    <a-sub-menu key="menu-sub-reports" v-if="userType('2') && !userRole(2)">
                        <template #title>
                            <span>
                                <LineChartOutlined />
                                <span>Reports</span>
                    ...
                    <a-menu-item key="menu-item-user-guide" v-if="userType('2') && !userRole(2)">
                        <SettingOutlined />
                        <span>User Guide</span>
                    </a-menu-item>
                    <a-menu-item key="menu-item-about-us" v-if="userType('2') && !userRole(2)">
                        <InfoCircleOutlined />
                        <span>About Us</span>
                    </a-menu-item>
                </a-menu>
