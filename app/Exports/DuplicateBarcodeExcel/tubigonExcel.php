...
class tubigonExcel implements FromCollection, WithTitle, WithHeadings, WithStyles, ShouldAutoSize, WithEvents
{
    /**
    * @return \Illuminate\Support\Collection
    */

    protected $tubigonData;


    public function __construct($barcode){
        $this->tubigonData = $barcode;
    }
    ...
    private function tubigonDataExcel($request)
    {
        ...
        ->select(
            ...
            ->whereIn('store_verification.vs_barcode', $this->tubigonData)
            ->get();
    }
}
