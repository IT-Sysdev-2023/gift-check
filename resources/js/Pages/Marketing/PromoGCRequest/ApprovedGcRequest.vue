<template>
    <div>
        <a-table bordered :pagination="false" :dataSource="data.data" :columns="columns">
            <template v-slot:bodyCell="{ column, record }">
                <template v-if="column.dataIndex === 'view'">
                    <a-button size="small" type="primary" @click="opendrawer(record.pgcreq_id)">
    ...
    <a-drawer  :closable="false" placement="bottom" height="480" title=" " :open="open" @close="onClose">
        <template #extra>
            <a-button size="small" danger type="primary" style="margin-right: 8px" @click="onClose">Close</a-button>
        </template>
        <a-tabs v-model:activeKey="activeKey">
            <a-tab-pane key="1" :tab="'Promo GC Request # ' + selectedData.pgcreq_reqnum">
                <a-card>
                    <a-row :gutter="[16, 16]">
                        <a-col :span="12">
                            <a-card>
                                <a-form-item label="Date Requested">
                                    <a-input v-model:value='selectedData.dateRequest' readonly />
                                </a-form-item>
                                <a-form-item label="Date Needed">
                                    <a-input v-model:value='selectedData.dateNeeded' readonly />
                                </a-form-item>
                                <a-form-item label="Promo GC Group">
                                    <a-input v-model:value='selectedData.pgcreq_group' readonly />
                                </a-form-item>
                                <a-form-item label="Remarks">
                                    <a-input v-model:value='selectedData.pgcreq_remarks' readonly />
                                </a-form-item>
                        ...
                        <a-col :span="12">
                            <a-card>
                                <a-table :pagination="false" :dataSource="barcodes" :columns="barcodeCol" />
                                <div>
                                    <div class="flex justify-end mt-5">
                                        <a-form-item label="Total">
                                            <a-input v-model:value="selectedData.pgcreq_total" readonly></a-input>
                                        </a-form-item>
                                    </div>
                                </div>
                            </a-card>
                    ...
                    <a-row :gutter="[16, 16]">
                        <a-col :span="12">
                            <a-form-item label="Date Recommended">
                                <a-input v-model:value="selectedData.requestApprovedDate" readonly/>
                            </a-form-item>
                            <a-form-item label="Remarks">
                                <a-input v-model:value="selectedData.pgcreq_remarks" readonly/>
                            </a-form-item>
                        ...
                        <a-col :span="12">
                            <a-form-item label="Time Recommended">
                                <a-input v-model:value="selectedData.requestApprovedTime"readonly />
                            </a-form-item>
                ...
                <a-row :gutter="[16, 16]">
                    <a-col :span="8">
                        <a-card>
                            <a-form-item label="Date Approved">
                                <a-input v-model:value="approvedDetails.requestApprovedDate" readonly/>
                            </a-form-item>
                            <a-form-item label="Remarks">
                    ...
                    <a-col :span="8">
                        <a-card>
                            <a-form-item label="Time Approved">
                                <a-input v-model:value="approvedDetails.requestApprovedTime" readonly/>
                            </a-form-item>
                    ...
                    <a-col :span="8">
                        <a-form-item label="Prepared By">
                            <a-input v-model:value="approvedDetails.prepby" readonly/>
                        </a-form-item>
                    </a-col>
                </a-row>
            </a-tab-pane>
...
export default {
    ...
    methods: {
        opendrawer(data) {
            axios.get(route('marketing.promoGcRequest.selected.approved'), {
                params: {
                    id: data
                }
            }).then(response => {
