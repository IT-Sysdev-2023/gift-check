<template>
    <AuthenticatedLayout>
        <a-card>
            ...
            <a-input-search allow-clear enter-button placeholder="Input search here..." v-model:value="approvedBudgetSearch" style="width: 25%; margin-left:75%"/>
            <a-table size="small" :data-source="record.data" :columns="columns" bordered :pagination="false" style="margin-top:10px">
