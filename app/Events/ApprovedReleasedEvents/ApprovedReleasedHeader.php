...
class ApprovedReleasedHeader implements ShouldBroadcastNow
{
    ...
    {
        return [
            new PrivateChannel('generating-app-release-reports-header.' . $this->user->user_id),
        ];
    }

    public function broadcastAs()
    {
        return 'generate-app-rel-header';
    }
