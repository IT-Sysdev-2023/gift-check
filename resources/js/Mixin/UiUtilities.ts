...
export function onProgress() {
    ...
    const openLeftNotification = (
        page?: { success: string; error: string },
...
export function getError<T extends object>(formState: InertiaForm<T>) {
    const getErrorStatus = (field: keyof T) => {
