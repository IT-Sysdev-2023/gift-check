<template>
    ...
    <div style="font-weight: bold; margin-left: 70%;">
        Search:
        <a-input allow-clear v-model:value="talibonSearchBox" style="border: 1px solid #1e90ff; width:60%"
    ...
    <div style=" margin-top: 15px;">
        ...
        <a-table :data-source="data.data" :columns="alturasTalibonColumns" :pagination="false" size="small" style="margin-top: 10px;">
...
export default {
    ...
    methods: {
        ...
        viewAlturasTalibon(rec) {
            ...
            this.$inertia.get(route('storeaccounting.talibonPosTransaction', rec.vs_barcode));
        }
