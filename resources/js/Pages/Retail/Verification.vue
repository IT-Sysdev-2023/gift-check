<template>
    <AuthenticatedLayout>
        <a-row :gutter="[16, 16]">
            <a-col :span="10">
                <a-card>
                    ...
                    <p class="mt-2 ml-1">Payment to:</p>
                    <a-select
                        ref="select"
                    ...
                    >
                        <a-select-option value="STORE DEPARTMENT"
                            >STORE DEPARTMENT</a-select-option
                        >
                        <a-select-option value="WHOLESALE"
                            >WHOLESALE</a-select-option
                        >
                    </a-select>
                    <div>
                        <a-button
                    ...
                    <a-select
                        ...
                        :filter-option="false"
                        :not-found-content="
                            isRetrieving ? undefined : 'No Customer found'
                        "
                        :options="optionCustomer"
                        @search="debounceCustomer"
                    >
            ...
            <a-col :span="14">
                <a-alert
                    v-if="success"
                    :message="'Barcode # ' + form.barcode + ' found'"
                    class="mb-1"
                    type="success"
                    show-icon
                />
                <a-alert
                    v-if="notfound"
                    :message="'Barcode # ' + form.barcode + '  not found'"
                    class="mb-1"
                    type="error"
                    show-icon
                />
                ...
                <a-card v-else>
                    <a-result
                        status="404"
                        title="Enter Barcode"
                        sub-title="In order to show barcode status"
                    >
                    </a-result>
                </a-card>
            </a-col>
        ...
        <a-modal
            title="Add Customer"
            v-model:open="addCustomerModal"
            @ok="customerSubmit"
        >
            <a-form-item
                :validate-status="
                    addingCustomer.errors?.firstname ? 'error' : ''
                "
            ...
            >
                ...
                <a-input
                    allow-clear
                    v-model:value="addingCustomer.firstname"
                    placeholder="firstname"
                ></a-input>
            </a-form-item>
            <a-form-item
                :validate-status="
                    addingCustomer.errors?.lastname ? 'error' : ''
                "
            ...
            >
                ...
                <a-input
                    allow-clear
                    v-model:value="addingCustomer.lastname"
                    placeholder="lastname"
                ></a-input>
            </a-form-item>
            <a-form-item
                :validate-status="
                    addingCustomer.errors?.middlename ? 'error' : ''
                "
            ...
            >
                ...
                <a-input
                    allow-clear
                    v-model:value="addingCustomer.middlename"
                    placeholder="middlename"
                ></a-input>
            </a-form-item>
            <a-form-item
                :validate-status="
                    addingCustomer.errors?.extention ? 'error' : ''
                "
            ...
            >
                ...
                <a-input
                    allow-clear
                    v-model:value="addingCustomer.extention"
                    placeholder="name extention"
                ></a-input>
            </a-form-item>
        </a-modal>
    </AuthenticatedLayout>
