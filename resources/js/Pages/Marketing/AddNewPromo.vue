...
export default {
    ...
    methods: {
        ...
        async fetch() {
            await axios
                .get(route("marketing.addPromo.get.denom"))
                .then((response) => {
        ...
        validateGc() {
            axios
                .post(route("marketing.addPromo.gcpromovalidation"), {
        ...
        scannedGc() {
            axios
                .get(route("marketing.addPromo.scannedGc"))
                .then((response) => {
        ...
        removeGc(data) {
            axios
                .post(route("marketing.addPromo.removeGc"), {
                    barcode: data,
                })
                .then((response) => {
                    notification[response.data.response.type]({
        ...
        addPromo() {
            axios
                .post(route("marketing.addPromo.newpromo"), {
                    data: this.form,
                })
                .then((response) => {
                    notification[response.data.response.type]({
