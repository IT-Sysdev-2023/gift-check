<template>
            ...
            >
                ...
                <a-dropdown>
                    <a
                        ...
                        style="
                            ...
                            color: #003140;
                        "
                        >View UserGuide by Page <DownOutlined />
                    </a>
                    <template #overlay>
                        <a-menu>
                            <a-menu-item>
                                <a
                                    ...
                                    href="javascript:;"
                                    ><AppstoreAddOutlined /> GC Requisition Per
                                    Store</a
                                >
                            </a-menu-item>
                            <a-menu-item>
                                <a
                                    ...
                                    class="heading-button"
                                    href="javascript:;"
                                    ><FundProjectionScreenOutlined /> How to
                                    Make GC Production (Regular GC)</a
                                >
                            </a-menu-item>
                            <a-menu-item>
                                <a
                                    ...
                                    class="heading-button"
                                    href="javascript:;"
                                    ><PullRequestOutlined /> How to Request
                                    Promo</a
                                >
                            </a-menu-item>
                            <a-menu-item>
                                <a
                                    ...
                                    class="heading-button"
                                    href="javascript:;"
                                    ><ForkOutlined /> How to Request Special
                                    External GC</a
                                >
                            </a-menu-item>
                            <a-menu-item>
                                <a
                                    ...
                                    class="heading-button"
                                    href="javascript:;"
                                    ><ShopOutlined /> Treasury Department</a
                                >
                            </a-menu-item>
                            <a-menu-item>
                                <a
                ...
                <a-dropdown>
                    <a
                        ...
                        class="ant-dropdown-link"
                        @click.prevent
                        >View UserGuide by PDF <DownOutlined />
                    </a>
                    <template #overlay>
                        <a-menu>
                            <a-menu-item>
                                <a
                                    ...
                                    class="heading-button"
                                    href="javascript:;"
                                    ><FilePdfOutlined /> GC Requisition Per
                                    Store</a
                                >
                            </a-menu-item>
                            <a-menu-item>
                                <a
                                    ...
                                    class="heading-button"
                                    href="javascript:;"
                                    ><FilePdfOutlined /> How to Make GC
                                    Production (Regular GC)</a
                                >
                            </a-menu-item>
                            <a-menu-item>
                                <a class="heading-button" href="javascript:;"
                                    ><FilePdfOutlined /> How to Request Promo</a
                                >
                            </a-menu-item>
                            <a-menu-item>
                                <a class="heading-button" href="javascript:;"
                                    ><FilePdfOutlined /> How to Request Special
                                    External GC</a
                                >
                            </a-menu-item>
                            <a-menu-item>
                                <a class="heading-button" href="javascript:;"
                                    ><FilePdfOutlined /> Treasury Department</a
                                >
                            </a-menu-item>
                        </a-menu>
                    </template>
    ...
    <a-card v-if="homePage" style="text-align: center"
        ...
        <div>
            <a>
                <img
                    src="https://private-user-images.githubusercontent.com/74038190/238353467-897cd757-ea1f-492d-aaf9-6d1674177e08.gif?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..9LzOTrI52pHUFyYbSSmd3z-HhTVU2vfJTVeQH0Pyiss"
    ...
    <a-card v-if="pdfGcProductionRegularGc" style="text-align: center"
        ><span
            style="
                font-size: 40px;
                color: #eb5b00;
