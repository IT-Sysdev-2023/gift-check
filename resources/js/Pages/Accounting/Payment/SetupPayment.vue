        ...
        <a-row :gutter="[16, 16]">
            <a-col :span="10">
                <a-descriptions size="small" layout="horizontal" bordered>
                    <a-descriptions-item style="width: 50%;" :span="3" label="RFSEGC #">{{ record.spexgc_num
                        }}</a-descriptions-item>
                    <a-descriptions-item :span="3" label="Department">{{ record.title }}</a-descriptions-item>
                    <a-descriptions-item :span="3" label="Date Requested">{{ record.datereq }}</a-descriptions-item>
                    <a-descriptions-item :span="3" label="Time Requested">{{ record.timereq }} </a-descriptions-item>
                    <a-descriptions-item :span="3" label="Date Needed">{{ record.dateneeded }}</a-descriptions-item>
                    <a-descriptions-item :span="3" label="Date Approved">{{ record.dateapp }}</a-descriptions-item>
                    <a-descriptions-item :span="3" label="Payment Amount">{{
                        Number(record.spexgc_payment).toLocaleString('en-US', {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                        }) }}</a-descriptions-item>
                    <a-descriptions-item :span="3" label="Total Denomination">{{ total }}</a-descriptions-item>
                ...
                <a-descriptions class="mt-5" :span="3" size="small" layout="horizontal" bordered>
                    <a-descriptions-item style="width: 50%;" label="Requested by">{{ record.reqby
                    }}</a-descriptions-item>
                </a-descriptions>
                <a-descriptions class="mt-1" :span="3" size="small" layout="horizontal" bordered>
